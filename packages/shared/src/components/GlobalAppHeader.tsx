      ...
      <div className="safe-px flex items-center justify-between gap-2 py-2">
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          {showSearch ? (
            <button
              type="button"
              onClick={() => openDevelopmentStub("Поиск по сервисам.")}
              className="flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-700 transition hover:bg-slate-50 active:translate-y-[1px] dark:border-slate-600 dark:bg-[rgb(var(--card))] dark:text-slate-200 dark:hover:bg-slate-800"
              aria-label="Поиск"
            >
