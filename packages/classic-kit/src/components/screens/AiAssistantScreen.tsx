...
const pillBase =
  "inline-flex items-center gap-2 rounded-full border border-[rgb(var(--border))] bg-[rgb(var(--card))] px-[14px] py-[10px] text-[13px] font-semibold text-[rgb(var(--text))] shadow-softSm transition hover:brightness-105 active:scale-[0.98]";
  ...
  return (
    <div className="space-y-4 pb-[140px]">
      <div>
            ...
            >
              <div className="flex h-full gap-3">
                {visibleHeroCards.map((slideKind) => (
                  ...
                  >
                    {slideKind === "weekly" ? (
                      <Card className="h-full rounded-2xl border-[rgb(var(--border))] bg-[rgb(var(--card))] shadow-none">
                        <CardContent className="flex h-full items-center gap-3 overflow-hidden pb-1.5 pt-1.5">
                          <button
                            type="button"
                            className="flex h-9 w-9 shrink-0 items-center justify-center self-center rounded-full bg-[rgb(var(--surface-2))] border border-[rgb(var(--border))]"
                            onClick={() => {
                              if (
                                typeof window === "undefined" ||
                          ...
                          >
                            {weeklySpeaking ? <Pause className="h-4 w-4 text-[rgb(var(--muted))]" /> : <Play className="h-4 w-4 text-[rgb(var(--muted))]" />}
                          </button>
                          <div className="min-w-0 flex-1">
                            <button
                              type="button"
                              className="flex min-w-0 flex-nowrap items-center gap-1.5 text-left text-xs font-semibold text-[rgb(var(--text))]"
                              onClick={() => {
                                setInput("звонки за неделю");
                                window.setTimeout(() => send("звонки за неделю"), 60);
                              }}
                            >
                              <Sparkles className="h-4 w-4 shrink-0 text-accent-orange" />
                              <span className="min-w-0 truncate">Еженедельный отчет</span>
                              <span className="shrink-0 text-[11px] font-normal text-[rgb(var(--muted))]">за 24 апреля</span>
                            </button>
                            <p className="mt-0.5 line-clamp-1 text-[11px] leading-snug text-[rgb(var(--muted))]">
                              126 звонков, 1 пропущенный, средняя длительность 2:40. Есть 4 клиента в риске по оплате.
                            </p>
                            <button
                              type="button"
                              className="mt-0.5 text-[11px] font-semibold text-accent-orange underline-offset-2 hover:underline"
                              onClick={() => {
                                setInput("звонки за неделю");
                                window.setTimeout(() => send("звонки за неделю"), 60);
                              }}
                          ...
                          <button
                            type="button"
                            className="shrink-0 rounded-full p-1 text-[rgb(var(--muted))] hover:bg-[rgb(var(--surface-2))]"
                    ...
                    {slideKind === "assist" ? (
                      <Card className="h-full rounded-2xl border-[rgb(var(--border))] bg-gradient-to-br from-accent-orange/10 to-[rgb(var(--card))] shadow-none">
                        <CardContent className="flex h-full items-center gap-3 pb-1.5 pt-1.5">
                          <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-accent-orange/15">
                            <Bot className="h-4 w-4 text-accent-orange" />
                          </span>
                          <div className="min-w-0 flex-1">
                            <div className="text-xs font-semibold text-[rgb(var(--text))]">AI ассистенты подключены</div>
                            <div className="mt-0.5 line-clamp-1 text-[11px] leading-snug text-[rgb(var(--muted))]">
                              У вас подключены AI ассистенты, но вы ими еще не пользовались.
                            </div>
                            <button
                              type="button"
                              className="mt-0.5 rounded-full bg-accent-orange px-3 py-1 text-[11px] font-semibold text-white transition hover:brightness-105"
                              onClick={() => {
              ...
              <div className="mt-2 flex justify-center gap-1.5">
                {visibleHeroCards.map((_, idx) => (
                  <button
                    key={`hero-dot-${idx}`}
                    type="button"
                    className={cn("h-1.5 rounded-full transition-all", heroCard === idx ? "w-5 bg-accent-orange" : "w-1.5 bg-[rgb(var(--border))]")}
          ...
          <div className="mt-3">
            <div className="flex flex-col items-center px-1 pt-0.5 text-center">
              <div className="flex items-center justify-center gap-1.5">
                <span className="text-[22px] font-semibold tracking-tight text-[rgb(var(--text))]">
                  Билайн
                </span>
                <Image
                  src={sphereSrc}
                ...
                />
                <span className="text-[22px] font-semibold tracking-tight text-accent-orange">One</span>
              </div>
              <h1 className="mt-0.5 max-w-[18rem] text-[26px] font-bold leading-[1.15] tracking-tight text-[rgb(var(--text))]">
                Ваш бизнес ассистент
              </h1>
              <p className="mt-1 text-[13px] text-[rgb(var(--muted))]">{userProfile.legalName}</p>
            </div>
              ...
              <div className="flex w-full max-w-[360px] flex-wrap justify-center gap-2">
                ...
                >
                  ...
                  {unpaidInvoicesCount > 0 ? (
                    <span className="flex h-5 min-w-[20px] items-center justify-center rounded-full bg-accent-orange px-1.5 text-[10px] font-bold text-white">
                      {unpaidInvoicesCount}
                    </span>
                  ) : null}
                </button>
        ...
        <div className="space-y-3">
          ...
          <button
            type="button"
            aria-label="Назад"
            className="mb-3 inline-flex items-center text-sm font-semibold text-[rgb(var(--muted))] transition hover:text-[rgb(var(--text))]"
            onClick={() => {
          ...
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[rgb(var(--surface-2))] border border-[rgb(var(--border))]">
          ...
          <div className="safe-px">
            <div className="flex flex-wrap gap-1.5">
              {chipTags.map((label) => (
                <div
                  key={label}
                  className="inline-flex items-center overflow-hidden rounded-full border border-[rgb(var(--border))] bg-[rgb(var(--card))] text-[11px] font-semibold leading-none text-[rgb(var(--text))] shadow-softSm"
                >
                  <button
                    type="button"
                    className="px-2.5 py-1 text-left hover:bg-[rgb(var(--surface-2))]"
                    onClick={() => {
                      setInput(label);
                  ...
                  <button
                    type="button"
                    className="border-l border-[rgb(var(--border))] px-1.5 py-1 text-[rgb(var(--muted))] hover:bg-[rgb(var(--surface-2))] hover:text-[rgb(var(--text))]"
                    aria-label="Убрать"
      ...
      {aiReplyPending ? (
        ...
        >
          <div className="safe-px">
            <div className="flex items-center justify-between gap-3 rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] px-3 py-2.5 shadow-md">
              <div className="flex min-w-0 items-center gap-2 text-sm font-medium text-[rgb(var(--text))]">
                <Loader2 className="h-4 w-4 shrink-0 animate-spin text-accent-orange" aria-hidden />
                <span>Готовим ответ…</span>
              </div>
              <button
                type="button"
                className="shrink-0 rounded-full border border-[rgb(var(--border))] bg-[rgb(var(--surface-2))] px-3 py-1.5 text-xs font-semibold text-[rgb(var(--text))] transition hover:brightness-105 active:scale-[0.97]"
      ...
      {toast ? (
        <div className="fixed bottom-[120px] left-0 right-0 z-40 mx-auto w-full max-w-[430px]">
          <div className="safe-px">
            <Card className="border-[rgb(var(--border))] bg-[rgb(var(--card))]/90 shadow-lg backdrop-blur-xl">
              <CardContent className="pb-3 pt-3">
                <div className="text-sm text-[rgb(var(--text))]">{toast}</div>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2 pb-1">
            {recentHistoryQuickPrompts.map((prompt) => (
              <button
                key={prompt}
                type="button"
                className="rounded-full border border-[rgb(var(--border))] bg-[rgb(var(--surface-2))] px-3 py-1.5 text-xs font-semibold text-[rgb(var(--text))] transition hover:brightness-105"
                onClick={() => {
                  setOpenHistory(false);
                  setInput(prompt);
          ...
          {chatHistoryPresets.map((h) => (
            <button
              key={h.id}
              type="button"
              className="w-full rounded-3xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-3 text-left shadow-softSm transition hover:brightness-105"
              onClick={() => {
            ...
            >
              <div className="text-sm font-semibold text-[rgb(var(--text))]">{h.title}</div>
              <div className="mt-1 line-clamp-2 text-xs text-[rgb(var(--muted))]">{h.preview}</div>
            </button>
          ))}
        </div>
      </Modal>
