  ...
  return (
    <div className="safe-px flex min-h-dvh flex-col bg-[rgb(var(--bg))] text-[rgb(var(--text))]">
      <header className="flex items-center justify-between border-b border-[rgb(var(--border))] bg-[rgb(var(--bg))]/95 pt-3 pb-3 backdrop-blur-md">
        <button
          type="button"
          className="flex h-10 w-10 items-center justify-center rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] text-[rgb(var(--text))] shadow-softSm transition hover:brightness-105 active:scale-95"
          aria-label="Назад"
      ...
      <h1 className="mt-10 text-[32px] font-bold lowercase leading-tight tracking-tight text-[rgb(var(--text))]">
        введите номер
      </h1>

      <div
        className="mt-5 rounded-3xl border border-accent-orange/30 bg-accent-orange/10 px-4 py-3.5 text-center shadow-softSm dark:bg-accent-orange/15"
        role="note"
      >
      ...
      <div className="mt-8 rounded-3xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] px-4 py-5 shadow-softSm">
        ...
        <button
          ...
          className="mt-6 text-left text-sm font-semibold text-accent-orange underline-offset-4 hover:underline"
        >
      ...
      <div className="mt-auto pb-[max(28px,env(safe-area-inset-bottom))]">
        <button
          type="button"
          onClick={submit}
          className="w-full rounded-2xl bg-accent-orange py-4 text-base font-bold lowercase text-white shadow-soft transition hover:brightness-105 active:scale-[0.98]"
        >
          продолжить
        </button>
      </div>
