        ...
        <CenteredPageTitleBar
          ...
          rightSlot={
            <button
              ...
              className={["flex h-8 w-8 items-center justify-center rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] text-[rgb(var(--muted))] shadow-softSm transition hover:brightness-105", getCustomizationButtonClasses(settingsCustom.dimmedDisabled)].join(" ")}
        ...
        <>
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className={["flex h-10 w-10 items-center justify-center rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] text-[rgb(var(--muted))] shadow-softSm transition hover:brightness-105 active:scale-95", getCustomizationButtonClasses(searchCustom.dimmedDisabled)].join(" ")}
              aria-label="Поиск"
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] text-[rgb(var(--muted))] shadow-softSm transition hover:brightness-105 active:scale-95"
            ...
            <button
              ...
              className={[
                "rounded-full border px-3 py-2 text-xs font-semibold transition active:scale-[0.97]",
                getCustomizationButtonClasses(teamCustom.dimmedDisabled),
                filter === "team"
                  ? "border-transparent bg-accent-orange text-white shadow-softSm"
                  : "border-[rgb(var(--border))] bg-[rgb(var(--card))] text-[rgb(var(--text))] shadow-softSm hover:brightness-105 dark:border-[rgb(var(--border))] dark:bg-[rgb(var(--card))]"
              ].join(" ")}
            ...
            <button
              ...
              className={[
                "inline-flex items-center gap-1.5 rounded-full border px-3 py-2 text-xs font-semibold transition active:scale-[0.97]",
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={[
                "rounded-full border px-3 py-1.5 text-[11px] font-semibold transition active:scale-[0.97]",
                getCustomizationButtonClasses(incomingCustom.dimmedDisabled),
                filter === "incoming"
                  ? "border-transparent bg-accent-orange text-white"
                  : "border-[rgb(var(--border))] bg-[rgb(var(--card))] text-[rgb(var(--text))] hover:brightness-105"
              ].join(" ")}
