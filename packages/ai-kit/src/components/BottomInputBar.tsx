              ...
              {!hasText ? (
                ...
                >
                  <span className="flex h-7 w-7 items-center justify-center rounded-full border border-[#A9B1C0] dark:border-slate-500">
                    <Pencil className="h-3.5 w-3.5 -rotate-2" strokeWidth={2} />
                  </span>
                  <Plus className="absolute bottom-[7px] right-[7px] h-2.5 w-2.5 text-[#5F6676] dark:text-slate-300" strokeWidth={2.4} />
                </button>
              ) : null}
